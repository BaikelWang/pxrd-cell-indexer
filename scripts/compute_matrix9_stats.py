#!/usr/bin/env python3
"""Compute matrix9 (full unconstrained 3x3 matrix) normalization stats from train jsonl."""
...
DEFAULT_OUTPUT = PROJECT_ROOT / "data" / "processed" / "lattice_matrix9_stats_100k_seed42.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compute matrix9 normalization stats")
